...
SRC_URI = "git://git.yoctoproject.org/linux-yocto-4.1.git;name=machine,lto,tinification,net-diet,staging,xip,tracing;branch=${KBRANCH},lto,tinification,net-diet,staging,xip,tracing; \
