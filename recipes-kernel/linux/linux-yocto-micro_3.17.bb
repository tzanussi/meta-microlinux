...
SRC_URI = "git://github.com/tzanussi/linux-yocto-micro-3.17.git;bareclone=1;branch=${KBRANCH},meta,lto,net-diet,tinification;name=machine,meta,lto,net-diet,tinification"
